					...
					<div class="body">
						<div class="row clearfix">
							<div class="col-lg-4 col-md-4 col-sm-4 text-center m-b-10">
								...
								<div class="sparkline m-t-20" data-type="bar" data-width="97%" data-height="21px" data-bar-Width="2" data-bar-Spacing="6" data-bar-Color="rgb(134, 139, 239)">
									7,5,3,1,5,9,8,5,2,6,5,4,2,5,8,4,5,6,3,5,7,8</div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 text-center m-b-10">
								<h3 class="counter m-b-0">$6,481</h3>
								<small class="text-muted">Annual Revenue </small>
								<div class="sparkline m-t-20" data-type="bar" data-width="97%" data-height="21px" data-bar-Width="2" data-bar-Spacing="6" data-bar-Color="rgb(25, 161, 183)">
									2,5,8,4,5,6,3,5,7,8,4,6,7,5,3,1,5,9,8,5,5,4</div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 text-center m-b-10">
								<h3 class="counter m-b-0">$3,915</h3>
								<small class="text-muted">Monthly Revenue</small>
								<div class="sparkline m-t-20" data-type="bar" data-width="97%" data-height="21px" data-bar-Width="2" data-bar-Spacing="6" data-bar-Color="rgb(254, 191, 15)">
									6,5,4,3,2,1,9,8,7,8,5,2,2,5,8,4,5,6,7,8,4,6</div>
							</div>
						</div>
				...
				<div class="card">
					...
					<div class="body">
						<ul class="inbox-widget list-unstyled clearfix">
							...
							<li class="inbox-inner"> <a href="javascript:void(0)">
									<div class="inbox-item">
										...
										<div class="inbox-item-info">
											...
											<p class="inbox-message">text of the printing and typesetting industry.
							...
							<li class="inbox-inner"> <a href="javascript:void(0)">
									<div class="inbox-item">
										<div class="inbox-img"> <img src="assets/images/xs/avatar4.jpg" alt="">
										</div>
										<div class="inbox-item-info">
											<p class="author">John Benjamin</p>
											<p class="inbox-message">simply dummy text of the printing and
				...
				<div class="card agent">
					...
					<div class="agent-content">
						...
						<ul class="agent-contact-details">
							...
							<li><i class="zmdi zmdi-email"></i><a href="https://thememakker.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7811161e17381d00191508141d561b1715">[email&#160;protected]</a>
							</li>
						</ul>
						<ul class="social-icons">
							<li><a class="facebook" href="javascript:void(0);"><i class="zmdi zmdi-facebook"></i></a></li>
							<li><a class="twitter" href="javascript:void(0);"><i class="zmdi zmdi-twitter"></i></a>
							</li>
							<li><a class="gplus" href="javascript:void(0);"><i class="zmdi zmdi-google-plus"></i></a></li>
							<li><a class="linkedin" href="javascript:void(0);"><i class="zmdi zmdi-linkedin"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="card agent">
					...
					<div class="agent-content">
						...
						<ul class="agent-contact-details">
							<li><i class="zmdi zmdi-phone"></i><span>(123) 123-456</span></li>
							<li><i class="zmdi zmdi-email"></i><a href="https://thememakker.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d3babdb5bc93b6abb2bea3bfb6fdb0bcbe">[email&#160;protected]</a>
							</li>
						</ul>
						<ul class="social-icons">
							<li><a class="facebook" href="javascript:void(0);"><i class="zmdi zmdi-facebook"></i></a></li>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="card agent">
					...
					<div class="agent-content">
						...
						<ul class="agent-contact-details">
							<li><i class="zmdi zmdi-phone"></i><span>(123) 123-456</span></li>
							<li><i class="zmdi zmdi-email"></i><a href="https://thememakker.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d8b1b6beb798bda0b9b5a8b4bdf6bbb7b5">[email&#160;protected]</a>
							</li>
						</ul>
						<ul class="social-icons">
							<li><a class="facebook" href="javascript:void(0);"><i class="zmdi zmdi-facebook"></i></a></li>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="card agent">
					...
					<div class="agent-content">
						...
						<ul class="agent-contact-details">
							<li><i class="zmdi zmdi-phone"></i><span>(123) 123-456</span></li>
							<li><i class="zmdi zmdi-email"></i><a href="https://thememakker.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="076e69616847627f666a776b622964686a">[email&#160;protected]</a>
							</li>
						</ul>
						<ul class="social-icons">
							<li><a class="facebook" href="javascript:void(0);"><i class="zmdi zmdi-facebook"></i></a></li>
						...
						<table class="table table-hover table-borderless m-b-0">
							...
							<tbody class="no-border-x">
								<tr>
									...
									<td class="actions"><a href="javascript:void(0);" class="icon"><i class="zmdi zmdi-plus-circle-o"></i></a></td>
								</tr>
								<tr>
									<td>2</td>
