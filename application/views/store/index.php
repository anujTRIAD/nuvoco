...
<div class="content-wrapper">  
	<section class="content-header">
		...
		<a href="<?php echo base_url('store/download_stores'); ?>" style="margin-right: 10px" class="pull-right btn btn-info"><i class="fa fa-download"></i> Download</a>

<?php // print_r($_SESSION); 
    if($_SESSION['role'] == "admin") { ?>
		<a href="<?php echo base_url('store/upload_csv_view'); ?>" style="margin-right: 10px" class="pull-right btn btn-success"><i class="fa fa-upload"></i> Upload Store</a>
		<a href="<?php echo base_url('store/upload_csv_view'); ?>" style="margin-right: 10px" class="pull-right btn btn-primary"><i class="fa fa-plus"></i> Add Store</a>
        <!-- <a href="<?php //echo base_url('store/master_uploader'); ?>" style="margin-right: 10px; background-color: darkslategray;border:1px solid darkslategray;" class="pull-right btn btn-warning"><i class="fa fa-upload"></i> Master Upload</a> -->
<?php } ?>	
	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="col-xs-12 table-responsive" style="margin-top: 25px;">
				<table id="store_table" class="table table-striped table-bordered" data-page-length='10'>
					<thead>
						<tr>
							<th>Store SAP ID</th>
							<th>Store name</th>
...
$('#store_table').on("change", '.onoffswitch-checkbox', function() {
    var chkbox = $(this);
    var active = '';
    ...
    if( !onoffswitch_ajax ) {
        ...
        $.ajax({
            url: "<?php echo base_url('store/status'); ?>",
            type: "POST",
